                                                    ...
                                                    <div class="con-input-file">
                                                        ...
                                                        <div class="img-1">
                                                            ...
                                                            if (!empty($rowFrm['Image'])) {
                                                                echo '<img class="image" id="customerimage" src="./ImageCustomer/' . htmlspecialchars($rowFrm['Image']) . '" alt="customerimage" width="200px">';
                                                            } else {
                                                            ?>
                                                        ...
                                                        <input class="input" onchange="processFile(event)" ondrop="dropHandler(event)" ondragover="dragOverHandler(event)" ondragleave="dragLeave(event)" ondragenter="dragEnter(event)" ondragenter="dragEnter(event)" type="file" accept="image/*" name="customerimage" id="">
                                                    </div>
                                                    <?php
                                                        if (isset($_REQUEST['Id'])) {
                                                            echo '
                                                                <input type="submit" value="UPDATE" class="btn btn-success btn-sm mt-5 " name="btnupdate">
                                                                <a href="customer-add.php" class="btn btn-info btn-sm mt-5"> New </a>
                                                            ';
                                                        } else {
                                                            echo '
